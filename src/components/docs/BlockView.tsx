                ...
                <tr key={r.id} className="group/row border-b border-border last:border-0 hover:bg-surface/40">
                  ...
                  <td className="text-right px-2">
                    <button
                      ...
                      className="no-print opacity-0 group-hover/row:opacity-100 p-1 rounded hover:bg-destructive/20 text-muted-foreground hover:text-destructive"
                    >
                      <Trash2 className="size-3.5" />
                    </button>
                  </td>
            ...
            <div key={e.id} className="surface-card rounded-xl overflow-hidden group/ep">
              <div className="flex items-center gap-3 px-4 py-3 border-b border-border bg-surface-2/40">
                ...
                <button
                  ...
                  className="no-print opacity-0 group-hover/ep:opacity-100 p-1 rounded hover:bg-destructive/20 text-muted-foreground hover:text-destructive"
                >
                  <Trash2 className="size-3.5" />
                </button>
              </div>
              ...
              {block.items.map((it, i) => (
                <tr key={it.id} className="group/m border-b border-border last:border-0 hover:bg-surface/40 align-top">
                  ...
                  <td>
                    <button
                      onClick={() => onChange({ ...block, items: block.items.filter((_, j) => j !== i) })}
                      className="no-print opacity-0 group-hover/m:opacity-100 p-1 rounded hover:bg-destructive/20 text-muted-foreground hover:text-destructive"
                    >
                      <Trash2 className="size-3.5" />
                    </button>
                  </td>
